      ...
      <ul class="right hide-on-med-and-down">
          ...
          <!-- <form style="position: relative; top: 10px;" v-on:submit.prevent="doSearch">
            <div class="input-field">
              ...
              <label class="label-icon" for="search"><i class="material-icons"
                  style="line-height: 50px;">search</i></label>
        ...
        <li v-if="user != null">
          ...
          <ul id='dropdown-user' class='dropdown-content' style="width: 140px;">
            <li><a href="javascript:void(0)" v-on:click="doLogout">Đăng Xuất</a></li>
          </ul>
        </li>

        <li>
          <router-link to="/cart">Giỏ hàng <span v-if="cartCounter > 0"
