<template>
	<div class="section no-pad-bot" id="index-banner">
		<div class="container-fluid">
			<h1 class="header center orange-text">A't Acrylic Color Thế giới màu sắc</h1>
			<div class="row center">
				<h5 class="header col s12 light">Bạn có thể chọn những màu sắc yêu thích tại đây</h5>
			</div>
			<br><br>
						...
						<div class="col m4" v-for="(product) in products" v-bind:key="product._id">
							<div class="card blue-grey darken-1">
								<div class="card-content white-text">
									...
									<p><span v-text="product.price"></span> VNĐ</p>
								</div>

								<div class="card-action">
									<router-link v-bind:to="'/product/' + product._id">Xem chi tiết</router-link>

									<span style="float: right; color: white;">Trong kho: <span
			...
			<div class="row">
				<div class="col offset-m6 m4">
					<button type="button" class="waves-effect waves-light btn" v-on:click="loadMore" ref="btnLoadMore">Xem
						Thêm</button>
				</div>
			</div>
		</div>
