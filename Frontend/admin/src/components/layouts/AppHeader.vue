  ...
  <aside
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <span class="ms-1 font-weight-bold text-white">A't Acrylic Color</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <router-link v-bind:class="'nav-link text-white ' + ($route.path == '/' ? 'bg-gradient-primary active' : '')"
            to="/">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">dashboard</i>
            </div>
            <span class="nav-link-text ms-1">Điều Khiển</span>
          </router-link>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Sản phẩm</h6>
        </li>
        <li class="nav-item">
          <router-link
            v-bind:class="'nav-link text-white ' + ($route.path == '/allProducts' ? 'bg-gradient-primary active' : '')"
            to="/allProducts">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <router-link
            v-bind:class="'nav-link text-white ' + ($route.path == '/addProduct' ? 'bg-gradient-primary active' : '')"
            to="/addProduct">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Đơn hàng</h6>
        </li>
        <li class="nav-item">
          <router-link
            v-bind:class="'nav-link text-white ' + ($route.path == '/allOrders' ? 'bg-gradient-primary active' : '')"
            to="/allOrders">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">list</i>
            </div>
