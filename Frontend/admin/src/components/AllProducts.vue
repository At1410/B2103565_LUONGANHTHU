                            ...
                            <table class="table align-items-center justify-content-center mb-0" id="products-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary opacity-7">Số lượng kho</th>
                                ...
                                <tbody>
                                    <tr v-for="(product) in products" v-bind:key="product._id.toString()">
                                        ...
                                        <td>
                                            <span v-text="product.price"></span> VNĐ
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <form v-on:submit.prevent="deleteProduct">
                                                ...
                                                <input type="submit" name="submit" class="btn btn-xs bg-gradient-primary"
                                                    value="Xóa" />
                                            </form>
                                        </td>
                                    </tr>
